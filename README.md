...
Import skips malformed rows, including non-object entries and gallery rows without URLs, and only reports galleries and feedback that could be applied to the local database.
