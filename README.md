...
Import skips malformed rows, including non-object entries, gallery rows without URLs, invalid tag JSON, and feedback/bootstrap rows with invalid numeric values. It only reports galleries and feedback that could be applied to the local database.
